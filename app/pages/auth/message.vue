  ...
  <div class="w-full max-w-md">
    <div class="flex flex-col items-center gap-6">
      <div class="w-20 h-20 rounded-full bg-primary-100 dark:bg-primary-900/30 flex items-center justify-center">
        <i class="pi pi-envelope text-4xl text-primary-600 dark:text-primary-400" />
      </div>
      <div class="text-center space-y-3">
        <p class="text-base text-surface-700 dark:text-surface-200">
          이메일을 확인해주세요
        </p>
...
useSeoMeta({
  ...
  ogTitle: 'MyComp - 이메일 확인',
  ogDescription: '이메일 확인을 완료해주세요',
  ogType: 'website',
  ogImage: '/og.svg',
  ogImageWidth: 1200,
  ogImageHeight: 630
